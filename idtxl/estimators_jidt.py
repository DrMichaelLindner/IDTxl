...
class JidtGaussianCTE(JidtGaussian):
    """Calculate conditional transfer entropy with JIDT's Gaussian implementation.

    Computes the differential conditional transfer entropy (TE) between two univariate
    sets of observations, conditioned on another, assuming that
    the probability distribution function for these observations is a
    multivariate Gaussian distribution.
    Call JIDT via jpype and use
    ConditionalTransferEntropyCalculatorGaussian estimator.
