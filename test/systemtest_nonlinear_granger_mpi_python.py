"""Run test on nonlinear data preparation and nonlinear PythonGaussianCMI estimation using MPI
    ...
    e.g. with num_threads 16:
        mpirun -n 16 python systemtest_nonlinear_granger_mpi_python.py 16
        srun -n 16 python systemtest_nonlinear_granger_mpi_python.py 16
        mpiexec -n 16 python systemtest_nonlinear_granger_mpi_python.py 16
"""
